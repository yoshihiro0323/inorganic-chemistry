...
\begin{tikzpicture}[box/.style={draw=black, rectangle, rounded corners=4pt, line width=1pt, inner sep=5pt, outer sep=0pt},arrow/.style={-latex,very thick}]
 \node[box, right, fill=orange!20!white] (CaCO3) {\ce{CaCO3}};
 \node[box, right] (CaO) at(3,0){\ce{CaO}};
 \node[box, right] (CaOH2) at(6,0){\ce{Ca(OH)2}};
 \node[box, right, fill=blue!10!white] (CaCl2) at(9,0){\ce{CaCl2}};
 ...
 \node[box] (CO2) at ([yshift=-15mm]1){\ce{CO2}};
 
 \coordinate (2) at ($(CaO.east)!0.5!(CaOH2.west)$);
 \node[box] (H2O) at ([yshift=-15mm]2){\ce{H2O}};
 \draw[arrow, red] (1)--(CO2.north);
 \draw[arrow, blue] (2)--(H2O.north);
 \node[box, right, fill=green!10!white] (NaCl) at(0,-3) {\ce{NaCl}};
 \node[box, right] (NaHCO3) at(3,-3){\ce{NaHCO3}};
 \node[box, right] (Na2CO3) at(6,-3){\ce{Na2CO3}};
 ...
 \coordinate (4-2) at ($(NaHCO3.east)!0.5!(Na2CO3.west)$);
 \draw[arrow, green!75!black] (CO2.south)--($(NaCl.east)!(CO2.south)!(NaHCO3.west)$);
 \node[box] (NH3) at ([yshift=-15mm]3-1){\ce{NH3}};
 \draw[arrow, green!75!black] (NH3.north)--(3-1.south);
 \node[box] (NH4Cl) at ([yshift=-15mm]4-2){\ce{NH4Cl}};
 \draw[arrow, green!75!black] (3-3)|-(NH4Cl.west);
...
\begin{enumerate}
 ...
 \hce{NaCl ＋ NH3 ＋ CO2 ＋ H2O → NH4Cl ＋ NaHCO3 ↓}
 \item \hl{炭酸水素ナトリウム}の\hl{熱分解}\\
 \hce{2 NaHCO3 → Na2CO3 ＋ H2O ＋ CO2 ↑}
 \item \hl{水酸化カルシウム}と\hl{塩化アンモニウム}
 \hce{2 NH4Cl ＋ Ca(OH)2 → CaCl2 ＋ 2 NH3 ↑ ＋ 2 H2O}
\end{enumerate}
\end{itembox}
