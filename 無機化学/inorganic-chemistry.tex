...
\begin{tikzpicture}[process/.style={below right, draw=black, rectangle, semithick, rounded corners=3pt, dash dot},arrow/.style={-Stealth,thick}]
 \node[below right, draw=black, rectangle, rounded corners=4pt, line width=1pt, inner sep=4pt, outer sep=0pt] (begin) {金属イオンの混合溶液};
 \node[process] (1st) at (1,-1){
 \begin{minipage}{3cm}
 \hl{希塩酸}\\
 $\Rightarrow$\hl{\ce{Cl-}}（\hl{酸}性）
 \end{minipage}
 };
 \node[process] (2nd) at (1,-3){
 \begin{minipage}{3cm}
 \hl{硫化水素}\\
 $\Rightarrow$\hl{\ce{S^2-}}（\hl{酸}性）
 \end{minipage}
 };
 \node[process] (3rd) at (1,-5){
 ...
 \node[process] (4th) at (1,-11){
 \begin{minipage}{3.5cm}
 \hl{硫化水素}を加える\\
 \hl{\ce{S^2-}}（\hl{塩基}性）
 \end{minipage}
 };
 \node[process] (5th) at (1,-13){
 \begin{minipage}{7cm}
 \begin{enumerate}
 \setlength{\leftskip}{-13pt}
 ...
 \node[below right, draw=black, rectangle, rounded corners=4pt, line width=1pt, inner sep=4pt, outer sep=0pt] (end) at (0,-16.5) {\hl{\ce{K^+}},\hl{\ce{Na^+}},\hl{\ce{Mg^+}}};
